...
export default function App() {
    const [coreVersion, setCoreVersion] = createSignal(null);
    ...
    onMount(async () => {
        ...
        try {
            const v = await invokeCommand('core_version');
            setCoreVersion(v);
        }
        catch (e) {
            setError(String(e));
    ...
    return (<main class="flex min-h-screen items-center justify-center bg-bg-primary text-fg-primary">
      <div class="flex flex-col items-center gap-3 text-center">
        ...
        <Show when={coreVersion()} fallback={<p class="mt-4 font-mono text-xs text-fg-secondary">
